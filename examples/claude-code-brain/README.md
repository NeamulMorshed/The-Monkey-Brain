...
15 sources (Karpathy's llm-wiki founding pattern, 10 Claude Code documentation pages, the qmd
README, the Bush 1945 Memex citation stub, and a v2 benchmark pair — Caveman and
ui-ux-pro-max) into 66 fully cross-linked, lint-clean wiki pages.
