...
**{{PROJECT}}**, built on the [LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f).
...
> `raw-sources/`. **Scope:** this brain is about **{{PROJECT}} only** — no unrelated context.
...
This `.brain/` is committed **with the {{PROJECT}} repo**. Commit per logical step using the
