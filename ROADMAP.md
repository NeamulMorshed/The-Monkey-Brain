...
| **P10** Always-on recall — built-in BM25 search MCP, `/brain:brief`, first-prompt recall | ⏳ next | v3 — see "v3 — Outgrowing MewVault" at the end |
| **P11** Real receipts — transcript usage + cache-hit ratio, cache-safety check, ledger outcomes, 3-OS CI | ⏳ | |
| **P12** Loops that stop — AC-terminated loops, livelock detection, verifier ≠ generator family | ⏳ | |
| **P13** Blast-radius routing — import-graph scanner → model + tier suggestion | ⏳ | |
