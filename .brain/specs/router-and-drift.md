...
**Release**
- **AC-12** — selftest ALL GREEN; both manifests `--strict`; CHANGELOG and manifests `0.33.0`. *(Build evidence: selftest 551 ALL GREEN; `--strict` ×2; 0.33.0 in both manifests, the CHANGELOG and the README badge. Left for the reviewer to re-run.)*
