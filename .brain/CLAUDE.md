...
**The Monkey Brain (engine)** project, built on the [LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f).
...
>
> **Scope & isolation:** this brain is about **The Monkey Brain (engine) only**. Its knowledge, log, and
...
This `.brain/` is committed **with the The Monkey Brain (engine) repo**. Commit per logical step using
